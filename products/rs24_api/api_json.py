...
def get_storages():
    ...
    resp = session.get(url=storages_url)
    return resp.json()
...
def _get_positions(storage_id, category, page=0):
    ...
    resp = session.get(url=positions_url)
    return resp.json()
...
def get_prices(position_code):
    ...
    resp = session.get(url=prices_url)
    return resp.json()
...
def get_remainder(storage_id, position_code):
    ...
    resp = session.get(url=remainder_url)
    return resp.json()
...
def get_specs(position_code):
    ...
    resp = session.get(url=specs_url)
    return resp.json()
